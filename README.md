...
En estas instrucciones vamos a desplegar sobre AWS, pero el despliegue de la aplicación en sí es con una Helm Chart, así que cualquier entorno de Kubernetes, ya sea en un proveedor de cloud o en una máquina de vuestra propiedad valdría.
...
Toda la aplicación se despliega mediante un Helm Chart que están en [el directorio stack de Github](https://github.com/anaireorg/anaire-cloud/tree/main/stack/anairecloud).
...
(el último campo es el path de la helm chart)
